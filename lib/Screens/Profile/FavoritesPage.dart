      ...
      body: Padding(
        ...
        child: Consumer2<BursaryProvider,Favoriteservice>(
            builder: (context,BursaryProvider,favService,child) {
              ...
              final favoritebursaries = filteredBursaries.where((bursary){
                return bursary.isFavorite == true;
              }).toList();
              if (favoritebursaries.isEmpty) {
                return ListView(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ListView.builder(
                          ...
                          itemCount: favoritebursaries.length,
                          itemBuilder: (context,index){
                            final bursary = favoritebursaries[index];
                            return Card(
                              child: SizedBox(
                                width: 350,
                                child: Column(
