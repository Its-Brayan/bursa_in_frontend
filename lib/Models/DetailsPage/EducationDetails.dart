class Educationdetails {
  ...
  Educationdetails({this.name_of_institution,this.course_level,this.year_of_study,this.year_of_completion,
  this.institution_postal_address,this.institution_tel_number});
